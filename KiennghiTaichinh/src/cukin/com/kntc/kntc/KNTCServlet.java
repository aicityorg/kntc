...
public class KNTCServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(method.compareTo("insert") == 0){
            ...
            out.write(KNTCService.update_data(mysqlurl, mysqluser, mysqlpass, data, updatedtime, type, id));
        }else if(method.compareTo("del") == 0){
            String id = params.get("key");
            out.write(KNTCService.delete_data(mysqlurl, mysqluser, mysqlpass, id));
        }
